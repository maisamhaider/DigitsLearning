package com.example.digitslearning.adapters;
...
public class HundredsNumbsAdapter extends RecyclerView.Adapter<HundredsNumbsAdapter.NumbsHolder> {
    ...
    public HundredsNumbsAdapter(Context context, ArrayList<String> numberArray, String[] numberWordArray, String[] numPronunciationArray) {
    ...
    public NumbsHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.hundred_numbs_item, parent, false);
                ...
                textToSpeech = new TextToSpeech(context, new TextToSpeech.OnInitListener() {
                    ...
                    public void onInit(int i) {
                        ...
                        if (!textToSpeech.isSpeaking()) {
                            textToSpeech.speak(holder.numPronounce_tv.getText(), TextToSpeech.QUEUE_FLUSH, null, null);
                        }
                    }
                });
            }
