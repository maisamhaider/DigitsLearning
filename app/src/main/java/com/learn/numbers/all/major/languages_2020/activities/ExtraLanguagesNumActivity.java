...
import com.learn.numbers.all.major.languages_2020.adapters.HundredsNumbsAdapter;
import com.learn.numbers.all.major.languages_2020.annotations.MAnnotation;
import com.learn.numbers.all.major.languages_2020.models.HundredNumbersModel;
...
public class ExtraLanguagesNumActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (s_extra_lang.matches(MAnnotation.ARABIC)) {
            ...
            adapter = new HundredsNumbsAdapter(this, getOneTo100Arabic(), arabicWords,
                    arabicEngPronounce);
            ...
            adapter = new HundredsNumbsAdapter(this, getOneTo100Arabic(), persianWords,
                    persianEngPronounce);
            ...
            adapter = new HundredsNumbsAdapter(this, getOneTo100Arabic(), pakhtuWords,
                    pakhtuEngPronounce);

        } else {
            list.add(new HundredNumbersModel(getOneTo100Arabic(), urduWords, urduEngPronounce));
            adapter = new HundredsNumbsAdapter(this, getOneTo100Arabic(), urduWords,
                    urduEngPronounce);
        }
