...
public class GEORGIANNumConverter implements Language {
    ...
    public final String[] tensNames = {
            "", " ati", " otsi", " otsdaati"," ormotsi"," ormotsdaati", " samotsi", " samotsdaati",
            " otkhmotsi",
            " otkhmotsdaati"};

    public final String[] numNames = {
            "",
            " erti", " ori", " saami", " otkhi", " khuti", " ekvsi", " švidi", " rava", " sukhra",
            " ati", " tertmetee", " tormetee", " tsametee", " totkhmetee", " tokhutmetee",
            " tekvsmetee", " čvidmetee", " tvrametee", " skhrametee"
    };
    ...
    public  String convert(long number) {
        ...
        if (billions == 0) {
            ...
            tradBillions = convertLessThanOneThousand(billions) + " miliardi ";
        }
        ...
        if (millions == 0) {
            ...
            tradMillions = convertLessThanOneThousand(millions) + " milioni ";
        }
        ...
        switch (hundredThousands) {
            ...
            case 1 :
                ...
                break;
            default :
                tradHundredThousands = convertLessThanOneThousand(hundredThousands) + " atasi) ";
        }
